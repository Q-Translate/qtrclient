...
function translateform_string($string, $lng) {
  ...
  $string['string'] = qcl::string_unpack($string['string']);
  ...
  //   $string = qcl::string_unpack($string);
...
function _translation($translation, $string_sguid, $lng) {
  ...
  $translation['translation'] = qcl::string_unpack($translation['translation']);
 ...
 *   An array of strings as generated by qcl::string_unpack().
 * @param string $empty
